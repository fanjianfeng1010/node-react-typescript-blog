      ...
      <Card className='about-wrapper' style={{ height: '100vh' }}>
        ...
        <ul>
          ...
          <li>
            技能
            <ul className='skill'>
              <li>HTML、CSS、Javascript：能熟练开发符合 W3C 标准的页面！</li>
              <li>react ：熟练掌握使用！</li>
              <li>es6：掌握基本面向对象编程实现！</li>
              <li>typescript:日常使用 typescript 构建类型明确的应用</li>
              <li>webpack: 入门级别，可以对脚手架进行针对性的配置！</li>
              <li>node mysql：针对需求可以做到简单的数据库设计、接口的开发与设计！</li>
              <li>
                个人
                <ul>
                  <li>良好的代码习惯,规范注释</li>
